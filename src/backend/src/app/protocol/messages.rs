...
pub const MSG_SYNCTHING_UPDATE_CHECK_REQUEST: u32 = 7;
pub const MSG_SYNCTHING_UPDATE_INSTALL_REQUEST: u32 = 8;
...
pub const MSG_SYNCTHING_UPDATE_CHECK_RESULT: u32 = 106;
pub const MSG_SYNCTHING_UPDATE_STATUS: u32 = 107;
